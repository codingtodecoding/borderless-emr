...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initTomSelect('complaints_select', 'complaints_hidden', '<?php echo e(old("complaints")); ?>');
    initTomSelect('known_conditions_select', 'known_conditions_hidden', '<?php echo e(old("known_conditions")); ?>');
    initTomSelect('diagnosis_select', 'diagnosis_hidden', '<?php echo e(old("diagnosis")); ?>');
    initTomSelect('treatment_select', 'treatment_hidden', '<?php echo e(old("treatment")); ?>');
    ...
    <?php if(old('lab_tests')): ?>
        selectedTests = <?php echo json_encode(old('lab_tests'), 15, 512) ?>;
    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/avinashvidyanand/Documents/projects/borderless/borderless-2402/resources/views/admin/patients/create.blade.php ENDPATH**/ ?>