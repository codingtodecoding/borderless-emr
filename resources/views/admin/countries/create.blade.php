...
<div style="margin-bottom: 25px;">
    <h2 style="margin: 0; color: #2e59a7;">
        <i class="bi bi-globe"></i> Add Country
    </h2>
</div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.countries.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" maxlength="2" placeholder="e.g., IN" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('phone_code') is-invalid @enderror" id="phone_code" name="phone_code" value="{{ old('phone_code') }}" placeholder="e.g., +91">
                    @error('phone_code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
