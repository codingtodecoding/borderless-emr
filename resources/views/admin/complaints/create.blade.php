...
@section('page-title', 'Add Complaint')
...
<div class="table-container">
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.complaints.store') }}" id="complaintForm">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control @error('complaint') is-invalid @enderror" id="complaint" name="complaint" rows="5" placeholder="Enter complaint details" required>{{ old('complaint') }}</textarea>
                        @error('complaint')
