...
@section('page-title', 'Add Lab Test')
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.lab-tests.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="e.g., CBC, SGOT, etc." required>
                    @error('name')
