...
<div style="margin-bottom: 25px;">
    <h2 style="margin: 0; color: #2e59a7;">
        <i class="bi bi-pencil-square"></i> Edit Diagnosis
    </h2>
</div>
...
<div class="table-container">
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.diagnoses.update', $diagnosis->id) }}" id="diagnosisForm">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text"
                               ...
                               id="title"
                               name="title"
                               value="{{ old('title', $diagnosis->title) }}"
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-lg"></i> Update Diagnosis
                    </button>
